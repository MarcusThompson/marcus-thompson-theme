...
function marcus_thompson_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'marcus-thompson' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'marcus-thompson' ) ); ?></div>
			<?php endif; ?>
...
function marcus_thompson_posted_on() {
	...
	$posted_on = sprintf(
		_x( 'Posted on %s', 'post date', 'marcus-thompson' ),
		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);

	$byline = sprintf(
		_x( 'by %s', 'post author', 'marcus-thompson' ),
